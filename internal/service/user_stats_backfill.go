...
// backfillStore is the narrow store interface BackfillUserStats depends on.
...
func BackfillUserStats(ctx context.Context, st backfillStore, logger *slog.Logger) error {
