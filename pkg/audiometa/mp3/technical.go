...
func parseTechnicalInfo(sr *binutil.SafeReader, tagSize int64, fileSize int64, meta *audiometa.Metadata) error {
		...
		if err == nil {
			...
			if bitrate > 0 && sampleRate > 0 {
				...
				if vbr {
					...
					meta.Duration = estimateCBRDuration(bitrate, fileSize, tagSize)
				}
