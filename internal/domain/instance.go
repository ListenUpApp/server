...
type Instance struct {
	...
	OpenRegistration bool      `json:"open_registration"` // Allow public signups (requires approval)
...
func (i *Instance) SetOpenRegistration(enabled bool) {
	i.OpenRegistration = enabled
	i.UpdatedAt = time.Now()
}
