// Package watcher monitors file system changes for audiobook libraries with platform-specific optimizations.
package watcher

import "context"

// Backend defines the platform-specific file watching implementation.
