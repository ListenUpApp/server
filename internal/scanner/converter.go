...
func ConvertToBook(item *LibraryItemData) (*domain.Book, error) {
	...
	// Convert audio files (yes, af vairable name still makes me laugh)
...
// compareFilenames compares two filenames, attempting to soort numerically
// ie. track1.mp3 < track2.mp3, track10.mp3 etc.
// A lot of this sorting (espeically multi-file) is based on what I *THINK* people
...
func compareFilenames(a, b string) int {
	...
	// TODO: Look into natural sort (numeric aware) for better soring.
	if a < b {
		return -1
	}
	if a > b {
